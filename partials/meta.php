...
<?php else: ?>
<meta property="og:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/splash/img/logo.png"/>
<?php endif; ?>
...
<?php else: ?>
<meta property="twitter:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/splash/img/logo.png"/>
<?php endif; ?>
...
<?php echo $metadata; ?>
<link href="<?php echo JWB; ?>autocomplete/css/jquery-ui.min.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo SWB; ?>template/splash/js/jquery.jcarousel.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/splash/js/jquery.transit.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/splash/js/bootstrap.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/splash/js/custom.js"></script>

<!-- Animation options
============================================= -->
<?php if($sysconf['template']['run_animation']) echo '<link rel="stylesheet" type="text/css" href="'.SWB.'template/splash/css/animate.min.css" />'; ?>

<!-- Style Minified
============================================= -->
<!-- <link rel="stylesheet" type="text/css" href="<?php echo SWB; ?>template/splash/style.min.css" /> -->
...
============================================= -->
<!-- For Developmet Only -->
<!-- <link rel="stylesheet/less" type="text/css" href="<?php echo SWB; ?>template/splash/style.less"/> -->
<!-- <script>less = { env: "development" };</script>
<script src="<?php echo $sysconf['template']['dir']; ?>/splash/js/less.min.js"></script> -->
