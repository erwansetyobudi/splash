  ...
  <form action="index.php" method="get" class="form-horizontal form-search">
    ...
    <div class="col-sm-6">
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="isbn" class="form-group" placeholder="<?php echo __('ISBN/ISSN'); ?>" />
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6">
      <div class="control-group">
        ...
        <div class="controls">
          <select name="colltype" class="form-group"><?php echo $colltype_list; ?></select>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6">
      <div class="control-group">
        ...
        <div class="controls">
          <select name="location" class="form-group"> <?php echo $location_list; ?></select>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6">
      ...
      <div class="controls">
        <select name="gmd" class="form-group"><?php echo $gmd_list; ?></select>
      </div>
      </div>
    </div>
