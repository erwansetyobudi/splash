...
if ($librarian_q->num_rows > 0) {
  while ($librarian = $librarian_q->fetch_assoc()) {
    ...
    echo '<div class="row-fluid"><div class="span7">'.$librarian['realname'].'</div></div>';
    echo '<div class="row-fluid"><div class="span7">'.$sysconf['system_user_type'][$librarian['user_type']].'</div></div>';
    echo '<div class="row-fluid"><div class="span7">'.$librarian['email'].'</div></div>';
    echo '<div class="row-fluid"><div class="span3 key">'.__('Social').'</div></br><div class="span9">';
    $social = array();
